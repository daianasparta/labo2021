...
switch ( Sys.info()[['sysname']],
         Windows = { directory.root  <-  "C:/Users/Jonathan/Desktop/MCD - Laboratorio/7.Labo_1" },   #Windows
...
kscript           <- "671_lgb_binaria1_enigma"
...
param <- list(learning_rate = 0.1, # el default
              ...
              prob_corte = 0.025 # el primero que pruebo
              )
...
param <- list(learning_rate = 0.1, # el default
              ...
              min_data_in_leaf = 4000, # el del script 612
              num_leaves = 31, # el default
              prob_corte = 0.020 # el segundo que pruebo
)
EstimarGanancia_lightgbm(param)
...
param <- list(learning_rate = 0.1, # el default
              ...
              min_data_in_leaf = 4000, # el del script 612
              num_leaves = 31, # el default
              prob_corte = 0.016 # este era el GANADOR EN EL PUBLIC!!!
)
EstimarGanancia_lightgbm(param)
...
param <- list(learning_rate = 0.1, # el default
              ...
              min_data_in_leaf = 4000, # el del script 612
              num_leaves = 31, # el default
              prob_corte = 0.03 # ultimo que pruebo!
)
EstimarGanancia_lightgbm(param)
