...
{
  dataset[  , mes := foto_mes %% 100 ] # El operador %% calcula el Modulo (resto de la division)! Si 201805/100 = 2018,05, entonces el restante es 5!!!
...
CanaritosImportancia  <- function( dataset )
{
  ...
  fwrite( tb_importancia, file="./work/impo_v005.txt",  , sep="\t" )
